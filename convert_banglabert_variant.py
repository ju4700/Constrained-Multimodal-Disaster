...
with open(r'd:\Development\iiucdatathon\banglabert_vision_notebook.py', 'r', encoding='utf-8') as f:
    source = f.read()
...
out_path = r'd:\Development\iiucdatathon\banglabert_vision_notebook.ipynb'
